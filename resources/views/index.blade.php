...
<div class="wrapper">
    <main class="main-content">
        <div class='edit-profile'>
            ...
            <form class='form' id='form' action="{{ route('user.add') }}" method='POST' enctype='multipart/form-data'>
                <ul class="form__list">
                    <li class="form__item">
                    ...
                    <li class="form__item">
                        ...
                        <input class='form__input' id='nickname' type="text" name="nickname" value="{{ old('nickname') }}">
                    </li>
                    <li class="form__item">
                    ...
                    <li class="form__item">
                        ...
                        <input class='form__input' id='surname' type="text" name="surname" value="{{ old('surname') }}">
                    </li>
                    <li class="form__item">
                    ...
                    <li class="form__item">
                        ...
                        <input class='form__input' id='phone' type="text" name="phone" value="{{ old('phone') }}">
                    </li>
                    ...
                    <li class="form__item">
                        ...
                        <input {{ old('consent_to_receive_email') ? 'checked' : '' }}
